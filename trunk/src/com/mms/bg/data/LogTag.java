...
public class LogTag {
    public static final String TAG = "MMS_BG";

    public static final String TRANSACTION = "MMS_BG:transaction";
    public static final String APP = "MMS_BG:app";
    public static final String THREAD_CACHE = "MMS_BG:threadcache";
